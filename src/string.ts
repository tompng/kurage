...
export type BezierSegmentWithColor = [Point3D, Point3D, Point3D, Point3D, Color, Color]
export class String3D {
  ...
  bezierSegmentsWithColor(c1: Color, c2: Color) {
    ...
    for (let i = 1; i < n; i++) {
      const t = i / n
      const c = { r: r1 + dr * t, g: g1 + dg * t, b: b1 + db * t }
